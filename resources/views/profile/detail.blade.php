                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('profile.store') }}" enctype="multipart/form-data">
                            ...
                            <x-text-input id="institusi" class="block mt-1 w-full" type="text" name="institusi"
                                :value="old(
                                    ...
                                    $user->profile && $user->profile->education
                                        ? $user->profile->education->institusi
                                        : '',
                                )" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="jurusan" class="block mt-1 w-full" type="text" name="jurusan"
                                :value="old(
                                    'jurusan',
                                    $user->profile && $user->profile->education
                                        ? $user->profile->education->jurusan
                                        : '',
                                )" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nilai_akhir" class="block mt-1 w-full" type="number"
                                name="nilai_akhir" :value="old(
                                    'nilai_akhir',
                                    $user->profile && $user->profile->education
